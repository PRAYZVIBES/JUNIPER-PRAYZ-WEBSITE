const copy = {
  en: {
    ...
    'hero.label':'Live duo / Franconia','hero.intro':'Voice, guitar and rhythm. Live on streets, in cafés and gardens, at private gatherings and in small venues.','hero.dates':'View live dates','hero.watch':'Watch live clips <span aria-hidden="true">↘</span>','hero.caption':'Live duo from Franconia',
    'dates.label':'Live dates','dates.title':'Shows and<br><em>plans.</em>','dates.note':'Planning placeholders. Dates and participation are not yet confirmed.','dates.tba':'Date TBA','dates.tourTba':'Dates TBA','dates.rudolstadtTitle':'Rudolstadt Festival','dates.rudolstadtMeta':'Rudolstadt, Germany / 2027','dates.rudolstadtStatus':'Festival appearance / placeholder','dates.bardTitle':'Bardentreffen','dates.bardMeta':'Nuremberg, Germany / 2027','dates.bardStatus':'City festival / placeholder','dates.tourTitle':'Southern Europe busking tour','dates.tourMeta':'Southern Europe / winter','dates.tourStatus':'Route and dates in planning',
  ...
  de: {
    ...
    'hero.label':'Live-Duo / Franken','hero.intro':'Stimme, Gitarre und Rhythmus. Live auf Straßen, in Cafés und Gärten, bei privaten Feiern und in kleinen Clubs.','hero.dates':'Live-Termine','hero.watch':'Live-Clips ansehen <span aria-hidden="true">↘</span>','hero.caption':'Live-Duo aus Franken',
    'dates.label':'Live-Termine','dates.title':'Auftritte und<br><em>Pläne.</em>','dates.note':'Planungsstand. Termine und Teilnahme sind noch nicht bestätigt.','dates.tba':'Termin folgt','dates.tourTba':'Termine folgen','dates.rudolstadtTitle':'Rudolstadt Festival','dates.rudolstadtMeta':'Rudolstadt, Deutschland / 2027','dates.rudolstadtStatus':'Festival-Auftritt / Platzhalter','dates.bardTitle':'Bardentreffen','dates.bardMeta':'Nürnberg, Deutschland / 2027','dates.bardStatus':'Stadtfestival / Platzhalter','dates.tourTitle':'Straßenmusik-Tour durch Südeuropa','dates.tourMeta':'Südeuropa / Winter','dates.tourStatus':'Route und Termine in Planung',
