const copy = {
  en: {
    'a11y.skip':'Skip to content','a11y.menu':'Open menu','nav.dates':'Dates','nav.live':'Live','nav.formats':'Formats','nav.shop':'Shop','nav.book':'Booking',
    'hero.label':'Live duo / Franconia','hero.intro':'Voice, guitar and rhythm. Live on streets, in cafés and gardens, at private gatherings and in small venues.','hero.dates':'13 Sep · Schönberg','hero.watch':'Watch live clips <span aria-hidden="true">↘</span>','hero.caption':'Live duo from Franconia',
    'dates.label':'Live dates','dates.title':'Shows and<br><em>plans.</em>','dates.note':'Our next confirmed live date is in Schönberg. Further appearances are being planned.','dates.schoenbergBadge':'Confirmed','dates.schoenbergDate':'13 Sep 2026','dates.schoenbergTitle':'Handwerkermarkt Schönberg','dates.schoenbergMeta':'Schönberg near Lauf a.d. Pegnitz','dates.schoenbergStatus':'Close-range live set · show time to follow','dates.schoenbergCalendar':'Save date ↘','dates.tba':'Date TBA','dates.tourTba':'Dates TBA','dates.rudolstadtTitle':'Rudolstadt Festival','dates.rudolstadtMeta':'Rudolstadt, Germany / 2027','dates.rudolstadtStatus':'Festival appearance / placeholder','dates.bardTitle':'Bardentreffen','dates.bardMeta':'Nuremberg, Germany / 2027','dates.bardStatus':'City festival / placeholder','dates.tourTitle':'Southern Europe busking tour','dates.tourMeta':'Southern Europe / winter','dates.tourStatus':'Route and dates in planning',
  ...
  de: {
    'a11y.skip':'Zum Inhalt springen','a11y.menu':'Menü öffnen','nav.dates':'Termine','nav.live':'Live','nav.formats':'Formate','nav.shop':'Shop','nav.book':'Booking',
    'hero.label':'Live-Duo / Franken','hero.intro':'Stimme, Gitarre und Rhythmus. Live auf Straßen, in Cafés und Gärten, bei privaten Feiern und in kleinen Clubs.','hero.dates':'13. Sep · Schönberg','hero.watch':'Live-Clips ansehen <span aria-hidden="true">↘</span>','hero.caption':'Live-Duo aus Franken',
    'dates.label':'Live-Termine','dates.title':'Auftritte und<br><em>Pläne.</em>','dates.note':'Unser nächster bestätigter Live-Termin ist in Schönberg. Weitere Auftritte sind in Planung.','dates.schoenbergBadge':'Bestätigt','dates.schoenbergDate':'13. Sep 2026','dates.schoenbergTitle':'Handwerkermarkt Schönberg','dates.schoenbergMeta':'Schönberg bei Lauf a.d. Pegnitz','dates.schoenbergStatus':'Nahes Live-Set · Auftrittszeit folgt','dates.schoenbergCalendar':'Termin merken ↘','dates.tba':'Termin folgt','dates.tourTba':'Termine folgen','dates.rudolstadtTitle':'Rudolstadt Festival','dates.rudolstadtMeta':'Rudolstadt, Deutschland / 2027','dates.rudolstadtStatus':'Festival-Auftritt / Platzhalter','dates.bardTitle':'Bardentreffen','dates.bardMeta':'Nürnberg, Deutschland / 2027','dates.bardStatus':'Stadtfestival / Platzhalter','dates.tourTitle':'Straßenmusik-Tour durch Südeuropa','dates.tourMeta':'Südeuropa / Winter','dates.tourStatus':'Route und Termine in Planung',
    ...
    'formats.label':'Formate','formats.title':'Wo wir<br><em>spielen.</em>','formats.intro':'Für eine Anfrage brauchen wir Datum, Ort, Anlass und die ungefähre Gästezahl.','formats.streetTitle':'Straße & Platz','formats.streetBody':'Ein kompaktes Setup für öffentliche Plätze und Straßenmusik.','formats.cafeTitle':'Café & Garten','formats.cafeBody':'Akustisch oder leicht verstärkt – je nach Raum.','formats.privateTitle':'Private Feier','formats.privateBody':'Musik für Feiern und persönliche Veranstaltungen.','formats.venueTitle':'Kleine Bühne','formats.venueBody':'Ein Duo-Set für Clubs, Kulturorte und kleine Bühnen.','formats.sofaTitle':'Sofakonzert','formats.sofaBody':'Ein persönliches JUNIPER-&-PRAYZ-Konzert bei euch zu Hause – buchbar über PRAYZVIBES.','formats.sofaCta':'Über PRAYZVIBES bei SofaConcerts buchen ↗',
