const copy = {
  en: {
    'a11y.skip':'Skip to content','a11y.menu':'Open menu','a11y.menuClose':'Close menu','a11y.navigation':'Main navigation','a11y.language':'Language','a11y.close':'Close','a11y.home':'JUNIPER & PRAYZ home','page.title':'JUNIPER & PRAYZ — Live duo from Franconia','nav.dates':'Dates','nav.live':'Live','nav.formats':'Formats','nav.shop':'Shop','nav.book':'Booking',
    'hero.label':'Live duo / Franconia','hero.intro':'Voice, guitar and rhythm. Live on streets, in cafés and gardens, at private gatherings and in small venues.','hero.dates':'13 Sep · Schönberg','hero.watch':'Watch live clips <span aria-hidden="true">↘</span>','hero.caption':'Live duo from Franconia','hero.imageAlt':'Juniper and Prayz outdoors',
    ...
    'about.label':'The duo','about.title':'Live music for streets<br><em>and small venues.</em>','about.body':'Juniper & Prayz perform as a compact duo with voice, guitar and rhythm. The setup stays light and can be adapted to the place and occasion.','about.note':'Based in Franconia. Available by arrangement.','about.bookingCta':'Go to booking ↘','about.bookingAria':'Book JUNIPER & PRAYZ',
    ...
    'book.label':'Booking','book.title':'Invite<br><em>JUNIPER & PRAYZ.</em>','book.body':'Please send the date, location, occasion, expected audience and available sound setup.','book.cta':'Send booking request','book.subject':'JUNIPER & PRAYZ booking request','book.partner':'Booking & support by PRAYZVIBES.COM ↗','footer.line':'Live duo from Franconia.','footer.partnerLabel':'Booking partner & sponsor','footer.imprint':'Imprint','footer.privacy':'Privacy','media.notice':'Playing this reel connects your browser to Instagram. Instagram’s privacy terms then apply.','media.open':'Open on Instagram ↗'
  },
  de: {
    'a11y.skip':'Zum Inhalt springen','a11y.menu':'Menü öffnen','a11y.menuClose':'Menü schließen','a11y.navigation':'Hauptnavigation','a11y.language':'Sprache','a11y.close':'Schließen','a11y.home':'Startseite von JUNIPER & PRAYZ','page.title':'JUNIPER & PRAYZ — Live-Duo aus Franken','nav.dates':'Termine','nav.live':'Live','nav.formats':'Formate','nav.shop':'Shop','nav.book':'Booking',
    'hero.label':'Live-Duo / Franken','hero.intro':'Stimme, Gitarre und Rhythmus. Live auf Straßen, in Cafés und Gärten, bei privaten Feiern und in kleinen Clubs.','hero.dates':'13. Sep · Schönberg','hero.watch':'Live-Clips ansehen <span aria-hidden="true">↘</span>','hero.caption':'Live-Duo aus Franken','hero.imageAlt':'Juniper und Prayz im Freien',
    ...
    'about.label':'Das Duo','about.title':'Live-Musik für Straßen<br><em>und kleine Bühnen.</em>','about.body':'Juniper & Prayz spielen als kompaktes Duo mit Stimme, Gitarre und Rhythmus. Das Setup bleibt leicht und lässt sich an Ort und Anlass anpassen.','about.note':'Aus Franken. Buchbar nach Absprache.','about.bookingCta':'Zum Booking ↘','about.bookingAria':'JUNIPER & PRAYZ buchen',
    ...
    'book.label':'Booking','book.title':'JUNIPER & PRAYZ<br><em>anfragen.</em>','book.body':'Schickt uns bitte Datum, Ort, Anlass, ungefähre Gästezahl und Informationen zur vorhandenen Tontechnik.','book.cta':'Booking-Anfrage senden','book.subject':'JUNIPER & PRAYZ Booking-Anfrage','book.partner':'Buchung & Support über PRAYZVIBES.COM ↗','footer.line':'Live-Duo aus Franken.','footer.partnerLabel':'Booking-Partner & Sponsor','footer.imprint':'Impressum','footer.privacy':'Datenschutz','media.notice':'Beim Abspielen verbindet sich dein Browser mit Instagram. Dann gelten die Datenschutzbedingungen von Instagram.','media.open':'Auf Instagram öffnen ↗'
  }
};
